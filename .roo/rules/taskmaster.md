...
This document provides a detailed reference for interacting with Taskmaster, covering both the recommended MCP tools, suitable for integrations like Roo Code, and the corresponding `npx task-master` CLI commands, designed for direct user interaction or fallback.
