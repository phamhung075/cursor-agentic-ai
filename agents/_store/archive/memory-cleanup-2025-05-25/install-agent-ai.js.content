...
class AgentAIInstaller {
  constructor() {
    ...
    this.requiredFiles = [
      ...
      'agents/_store/scripts/demo_agent.js',
      'agents/_store/scripts/self_improvement_agent_legacy.js',
      'agents/_store/templates/environment-template.env',
      'agents/_store/tests/',
      'agents/README.md',
    ...
    this.agentScripts = {
      "AAI:start": "node agents/self-improvement/index.js",
      "AAI:agent": "node agents/self-improvement/index.js",
      "AAI:analyze": "node agents/self-improvement/index.js",
      "AAI:improve": "node agents/self-improvement/index.js",
      ...
      "AAI:migrate-files": "node agents/utils/migrate_to_store.js",
      "AAI:setup-env": "node agents/_store/scripts/setup-env.js",
      "AAI:test-startup": "node agents/self-improvement/index.js --test"
    };
  }
  ...
  showHelp() {
    ...
    console.log('  ✅ Complete Agent AI system (agents/ directory)');
    ...
    console.log('📚 Full documentation: agents/_store/docs/INSTALLATION_GUIDE.md');
  }
  ...
  async copyAgentFiles(targetDir) {
    for (const filePattern of this.requiredFiles) {
      ...
      try {
        ...
        console.warn(`  ⚠️ ${filePattern} - ${error.message}`);
      }
    }
  }
  ...
  async setupDirectories(targetDir) {
    const directories = [
      ...
      'agents/_store/memory/embeddings',
      'agents/_store/memory/contexts', 
      'agents/_store/memory/learning',
      'agents/_store/logs'
    ];
  ...
  async setupEnvironment(targetDir) {
    ...
    const envContent = `# 🧠 Agent AI - Environment Configuration
# Copy this to .env and fill in your API keys

# ==================================================
# 🌐 Pinecone Configuration (for Agent Memory)
# ==================================================
...
`;
    ...
    try {
      ...
      if (!gitignoreContent.includes('agents/_store/memory/')) {
  ...
  showSuccessMessage(targetDir) {
    console.log('\n🎉 Agent AI Installation Complete!');
    console.log('=' .repeat(50));
    ...
    console.log('\n💡 Available Commands:');
    Object.entries(this.agentScripts).forEach(([script, command]) => {
      console.log(`   npm run ${script}`);
    });
    console.log('\n📚 Documentation:');
    console.log('   agents/README.md - Agent system overview');
    console.log('   agents/_store/docs/ - Complete documentation');
    console.log('\n🎯 The Agent AI is ready to enhance your project!');
  }
