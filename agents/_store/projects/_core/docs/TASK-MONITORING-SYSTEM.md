...
node agents/_store/projects/_core/scripts/start-task-monitoring.js

# Or start monitoring manually
node agents/_store/projects/_core/scripts/nested-task-monitor.js start
```

### Basic Task Operations
```bash
# Add a new task
node agents/_store/projects/_core/scripts/task-logger-helper.js add "New Feature Task" feature high

# Start a task
node agents/_store/projects/_core/scripts/task-logger-helper.js start task_001

# Update progress
node agents/_store/projects/_core/scripts/task-logger-helper.js progress task_001 50

# Complete a task
node agents/_store/projects/_core/scripts/task-logger-helper.js complete task_001 8

# List tasks
node agents/_store/projects/_core/scripts/task-logger-helper.js list pending
```
...
### Error Logging
All errors are logged to `agents/_store/logs/task-monitoring/errors.log` with:
...
1. Check error logs in `agents/_store/logs/task-monitoring/errors.log`
