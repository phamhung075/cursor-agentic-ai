...
class NestedTaskMonitor extends EventEmitter {
    constructor() {
        ...
        this.tasksFile = path.join(this.projectRoot, 'agents/_store/projects/_core/tasks/nested_tasks.json');
        this.logsDir = path.join(this.projectRoot, 'agents/_store/logs/task-monitoring');
