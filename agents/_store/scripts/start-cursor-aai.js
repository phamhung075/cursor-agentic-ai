...
class CursorAAIStarter {
  ...
  showStartupOptions() {
    ...
    console.log('   • agents/_store/cursor-summaries/script-summary.json');
    console.log('   • agents/_store/cursor-summaries/script-improvements.json');
  ...
  static async showStatus() {
    ...
    const files = {
      ...
      'agents/_store/cursor-summaries/script-summary.json': 'Script summary',
      'agents/_store/cursor-summaries/script-improvements.json': 'Improvements',
