...
# Updated for agents/_store/projects/_core structure instead of .cursor
...
CORE_DIR="agents/_store/projects/_core"
...
2. Copy to project: cp -R "$(basename "$BACKUP_DIR")/_core" "agents/_store/projects/"
3. Verify structure: ls -la "agents/_store/projects/_core"
