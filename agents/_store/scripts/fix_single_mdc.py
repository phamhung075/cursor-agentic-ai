...
def fix_mdc_file_paths(file_path):
    ...
    path_mappings = {
        '01_Idea.mdc': 'agents/_store/projects/_core/rules/01__AI-RUN/01_Idea.mdc',
        '03_Core_Concept.mdc': 'agents/_store/projects/_core/rules/01__AI-RUN/03_Core_Concept.mdc', 
        '04_PRD_Generation.mdc': 'agents/_store/projects/_core/rules/01__AI-RUN/04_PRD_Generation.mdc',
        '05_Specs_Docs.mdc': 'agents/_store/projects/_core/rules/01__AI-RUN/05_Specs_Docs.mdc',
        '07_Start_Building.mdc': 'agents/_store/projects/_core/rules/01__AI-RUN/07_Start_Building.mdc'
    }
...
def main():
    ...
    if len(sys.argv) != 2:
        ...
        print("Example: python3 fix_single_mdc.py agents/_store/projects/_core/rules/01__AI-RUN/02_Market_Research.mdc")
        sys.exit(1)
