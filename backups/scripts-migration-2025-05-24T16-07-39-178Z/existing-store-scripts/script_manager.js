...
class ScriptManager {
  ...
  async getNpmScripts() {
    try {
      ...
      for (const [name, command] of Object.entries(packageJson.scripts || {})) {
        if (command.includes('agents/_store/scripts/') || command.includes('agents/_store/tests/')) {
  ...
  displayResults() {
    ...
    // Display scripts
    console.log('🔧 SCRIPTS (agents/_store/scripts/)');
    ...
    // Display tests  
    console.log('🧪 TESTS (agents/_store/tests/)');
    console.log('━'.repeat(50));
  ...
  async organizeScripts() {
    ...
    console.log('   agents/_store/scripts/');
    Object.keys(this.categories.scripts).forEach(cat => {
      console.log(`   ├── ${cat}/`);
    });
    console.log('   agents/_store/tests/'); 
  ...
  showHelp() {
    ...
    console.log('   Migrate scripts from ./scripts to agents/_store/scripts');
    console.log('');
    console.log('💡 DIRECT USAGE:');
    console.log('   node agents/_store/scripts/script_manager.js [command]');
    console.log('');
    console.log('📂 SCRIPT LOCATIONS:');
    console.log('   📁 agents/_store/scripts/ - All utility scripts');
    console.log('   📁 agents/_store/tests/   - All test files');
    console.log('');
    console.log('📋 ORGANIZATION RULES:');
    console.log('   📖 See: agents/_store/projects/_core/rules/00__TOOLS/SCRIPT_ORGANIZATION_RULES.mdc');
  }
}
