...
exec('lsof +D .cursor/rules/agents/_store/logs/task-monitoring 2>/dev/null', (error, stdout, stderr) => {
  if (stdout.trim()) {
...
const tasksFile = '.cursor/rules/agents/_store/projects/_core/tasks/nested_tasks.json';
const logsDir = '.cursor/rules/agents/_store/logs/task-monitoring';
...
// Check launch script
const launchScript = '.cursor/rules/agents/_store/scripts/launch-aai-complete.js';
