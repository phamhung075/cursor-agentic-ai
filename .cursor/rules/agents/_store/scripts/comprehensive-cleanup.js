 ...
 * and cleans up the .cursor/rules/agents directory structure
 */
...
class AAIComprehensiveCleanup {
  constructor() {
    ...
    this..cursor/rules/agentsDir = path.join(this.baseDir, '.cursor/rules/agents');
    this.storeDir = path.join(this..cursor/rules/agentsDir, '_store');
  ...
  async run() {
    ...
    console.log('🔍 Analyzing .cursor/rules/agents directory structure...\n');
  ...
  async updatePackageJson() {
    ...
    // Add cleanup script
    packageData.scripts['AAI:cleanup'] = 'node .cursor/rules/agents/_store/scripts/comprehensive-cleanup.js';
    packageData.scripts['AAI:memory-index'] = 'cat .cursor/rules/agents/_store/memory/index.json';
...
`;
  ...
  showSummary() {
    ...
    console.log('   🗂️ Archive location: .cursor/rules/agents/_store/archive/');
    console.log('   💾 Memory location: .cursor/rules/agents/_store/memory/');
    console.log('');
    console.log('✨ Your .cursor/rules/agents directory is now clean and organized!');
  }
}
