...
class CursorMDCIntegration {
  ...
  async updateCursorSettings() {
    ...
    settings['files.watcherExclude'] = {
      ...
      '**/.cursor/rules/agents/_store/cursor-summaries/mdc-dependency-updates.json': false
    };
    ...
    settings['cursor.ai.contextFiles'] = [
      ...
      '.cursor/rules/agents/_store/cursor-summaries/mdc-dependency-updates.json'
    ];
    ...
    const mdcTasks = [
      {
        ...
        type: "shell",
        command: "node",
        args: [".cursor/rules/agents/_store/scripts/mdc-dependency-tracker.js", "init"],
        group: "build",
        presentation: {
          echo: true,
          reveal: "always",
      ...
      },
      {
        ...
        type: "shell",
        command: "node",
        args: [".cursor/rules/agents/_store/scripts/mdc-dependency-tracker.js", "watch"],
        group: "build",
        isBackground: true,
        presentation: {
          echo: true,
      ...
      },
      {
        ...
        type: "shell",
        command: "node",
        args: [".cursor/rules/agents/_store/scripts/mdc-dependency-tracker.js", "scan"],
        group: "build",
        presentation: {
          echo: true,
          reveal: "always",
      ...
      },
      {
        ...
        type: "shell",
        command: "node",
        args: [".cursor/rules/agents/_store/scripts/mdc-dependency-tracker.js", "status"],
        group: "test",
        presentation: {
          echo: true,
          reveal: "always",
...
class CursorMDCWatcher {
  ...
  async processUpdateQueue() {
    ...
    try {
      ...
      execSync('node .cursor/rules/agents/_store/scripts/mdc-dependency-tracker.js scan', {
        stdio: 'inherit',
        cwd: process.cwd()
      });
...
`;
    ...
    const watcherPath = '.cursor/rules/agents/_store/scripts/cursor-mdc-watcher.js';
  ...
  showStatus() {
    ...
    const files = {
      ...
      '.cursor/rules/agents/_store/scripts/mdc-dependency-tracker.js': 'Dependency tracker',
      '.cursor/rules/agents/_store/scripts/cursor-mdc-watcher.js': 'File watcher',
