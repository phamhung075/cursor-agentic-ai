 ...
 * Automatically analyzes dependencies and affected files when deleting or editing .cursor/rules/agents
    ...
    async analyzeSystemIntegrations(targetFile) {
        ...
        const systems = [
            ...
            },
            {
                ...
                files: ['.cursor/rules/agents/_store/intelligence/**/*.json'],
                impact: 'medium'
            },
            {
                name: 'Launch System',
                files: ['.cursor/rules/agents/_store/scripts/launch-*.js'],
                impact: 'high'
            }
        ];
...
async function main() {
    ...
    if (args.length < 2) {
        ...
        console.log(chalk.gray('Example: node enhanced-dependency-analyzer.js delete .cursor/rules/agents/_store/scripts/simple-cursor-setup.js'));
        process.exit(1);
    }
