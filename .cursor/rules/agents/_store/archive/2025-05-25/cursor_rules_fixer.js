...
class CursorRulesFileFixer {
  ...
  async fixFilePaths(filePath, issues) {
    ...
    const pathMappings = {
      ...
      '.cursor/rules/agents/self-improvement/': '.cursor/rules/agents/self-improvement/',
      '.cursor/rules/agents/_store/': '.cursor/rules/agents/_store/',
  ...
  async syncWithAgentCapabilities(filePath) {
    ...
    const agentUpdates = {
      ...
      'project files': 'project files (organized in .cursor/rules/agents/_store structure)',
      'test files': 'test files (located in .cursor/rules/agents/_store/tests)',
      'documentation': 'documentation (organized in .cursor/rules/agents/_store/docs)'
    };
